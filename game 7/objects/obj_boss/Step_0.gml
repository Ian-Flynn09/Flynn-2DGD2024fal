...
if (instance_exists(obj_player)) {
    ...
    if (fireball_cooldown <= 0) {
        ...
        // Reset cooldown
        fireball_cooldown = 90; // Cooldown for 60 steps
